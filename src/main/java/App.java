...
public class App {
    ...
    public void report6() throws IOException {
        StringBuilder sb = new StringBuilder();
        try {
            // Create an SQL statement
            Statement stmt = con.createStatement();

            // SQL statement to get the population of a specific country (e.g., Brazil)
            String sql = "SELECT name, population FROM country WHERE name = 'Brazil'";
            ...
            BufferedWriter writer = new BufferedWriter(
                    new FileWriter(new File("./output/report6.txt")));
